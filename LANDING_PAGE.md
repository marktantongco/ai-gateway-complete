...
## Design direction
Prismatic Passage. Palette: Oxblood, hot coral, blush, and amber. The hero uses authored CSS 3D transforms and SVG/CSS 2D motion. This is a static visual illustration, not live telemetry or an interactive backend demo.
