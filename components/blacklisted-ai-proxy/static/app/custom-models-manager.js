            ...
            tbody.innerHTML = `
                <tr>
                    <td colspan="6" class="table-empty-state">
                        ...
                        <div class="empty-text" data-i18n="customModels.noModels">No custom models yet</div>
                        <div class="empty-hint">Click "Add Model" button to start creating</div>
                    </td>
                </tr>`;
            ...
            <tr>
                ...
                <td>
                    <div class="action-buttons">
                        <button class="icon-btn edit edit-model-btn" data-id="${model.id}" title="Edit Model">
                            <i class="fas fa-edit"></i>
                        </button>
                        <button class="icon-btn delete delete-model-btn" data-id="${model.id}" title="Delete Model">
